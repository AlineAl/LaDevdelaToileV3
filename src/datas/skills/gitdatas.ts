export const gitdatas = [
  {
    ...
    description:
      "Cheat sheet proposé par GitHub pour apprendre les commandes de base de Git.",
    path: "https://education.github.com/git-cheat-sheet-education.pdf",
  },
  {
    title: "Gérez du code avec Git et GitHub",
    description:
      "Cours proposé par OpenClassrooms pour apprendre à gérer du code avec Git et GitHub.",
  ...
  {
    title: "Apprendre Github de zéro",
    description: "Cours proposé par From Scratch pour apprendre GitHub.",
    path: "https://youtu.be/eXF0epLeCgo?si=H6pYKyv6Jf5ftyXl",
  },
]
